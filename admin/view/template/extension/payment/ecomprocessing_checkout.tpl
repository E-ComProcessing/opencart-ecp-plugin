    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button type="button" id="<?php echo $module_name;?>_submit" data-form="form-ecomprocessing_checkout" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid module-controls-container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form data-action="<?php echo $action; ?>" data-method="post" enctype="multipart/form-data" id="form-ecomprocessing_checkout" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="<?php echo $module_name;?>_username" name="<?php echo $module_name;?>_username" value="<?php echo $ecomprocessing_checkout_username; ?>" placeholder="<?php echo $entry_username; ?>" id="input-account" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="<?php echo $module_name;?>_password" name="<?php echo $module_name;?>_password" value="<?php echo $ecomprocessing_checkout_password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-secret" class="form-control" />
                                </div>
                            </div>
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_sandbox; ?>">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_sandbox"
                                           value="<?php echo $ecomprocessing_checkout_sandbox;?>" />
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <select id="<?php echo $module_name;?>_transaction_type" name="<?php echo $module_name;?>_transaction_type[]" id="input-order-status" class="form-control" multiple="multiple">
                                        ...
                                        <?php if (is_array($ecomprocessing_checkout_transaction_type) && in_array($transaction_type['id'], $ecomprocessing_checkout_transaction_type)) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="<?php echo $module_name;?>_bank_codes" name="<?php echo $module_name;?>_bank_codes[]" class="form-control" multiple="multiple">
                                        ...
                                        <?php if (is_array($ecomprocessing_checkout_bank_codes) && in_array($bank_code['id'], $ecomprocessing_checkout_bank_codes)) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_wpf_tokenization"
                                           value="<?php echo $ecomprocessing_checkout_wpf_tokenization;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                                    <?php if ($ecomprocessing_checkout_wpf_tokenization) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="ecomprocessing_checkout_threeds_allowed">
                                    <span data-toggle="tooltip" title="<?php echo $help_threeds_allowed; ?>">
                                        <?php echo $entry_threeds_allowed; ?>
                                    </span>
                                </label>
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_threeds_allowed"
                                           value="<?php echo $ecomprocessing_checkout_threeds_allowed;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox" id="ecomprocessing_checkout_threeds_allowed"
                                    <?php if ($ecomprocessing_checkout_threeds_allowed) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="ecomprocessing_checkout_threeds_challenge_indicator">
                                    <span data-toggle="tooltip" title="<?php echo $help_threeds_challenge_indicator; ?>">
                                        <?php echo $entry_threeds_challenge_indicator; ?>
                                    </span>
                                </label>
                                <div class="col-sm-10">
                                    <select name="ecomprocessing_checkout_threeds_challenge_indicator" id="ecomprocessing_checkout_threeds_challenge_indicator" class="form-control">
                                        <?php foreach ($threeds_challenge_indicators as $threeds_challenge_indicator) { ?>
                                        <?php if ($threeds_challenge_indicator['id'] == $ecomprocessing_checkout_threeds_challenge_indicator) { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="ecomprocessing_checkout_sca_exemption">
                                    <span data-toggle="tooltip" title="<?php echo $help_sca_exemption; ?>">
                                        <?php echo $entry_sca_exemption; ?>
                                    </span>
                                </label>
                                <div class="col-sm-10">
                                    <select name="ecomprocessing_checkout_sca_exemption" id="ecomprocessing_checkout_sca_exemption" class="form-control">
                                        <?php foreach ($sca_exemptions as $sca_exemption) { ?>
                                        <?php $selected = ($sca_exemption['id'] == $ecomprocessing_checkout_sca_exemption) ? ' selected="selected" ' : ''; ?>
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_sca_exemption_amount; ?>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ecomprocessing_checkout_sca_exemption_amount" value="<?php echo $ecomprocessing_checkout_sca_exemption_amount; ?>" placeholder="<?php echo $entry_sca_exemption_amount; ?>" id="input-sca_exemption_amount" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                            <span data-toggle="tooltip" title="<?php echo $help_supports_partial_capture; ?>">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_supports_partial_capture"
                                           value="<?php echo $ecomprocessing_checkout_supports_partial_capture;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                                    <?php if ($ecomprocessing_checkout_supports_partial_capture) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_supports_partial_refund; ?>">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_supports_partial_refund"
                                           value="<?php echo $ecomprocessing_checkout_supports_partial_refund;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                                    <?php if ($ecomprocessing_checkout_supports_partial_refund) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_supports_void; ?>">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_supports_void"
                                           value="<?php echo $ecomprocessing_checkout_supports_void; ?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                                    <?php if ($ecomprocessing_checkout_supports_void) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="ecomprocessing_checkout_order_status_id">
                            <span data-toggle="tooltip" title="<?php echo $help_order_status; ?>">
                                <?php echo $entry_order_status; ?>
                            </span>
                                </label>
                                <div class="col-sm-10">
                                    <select name="ecomprocessing_checkout_order_status_id" id="ecomprocessing_checkout_order_status_id" class="form-control">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="ecomprocessing_checkout_order_failure_status_id">
                            <span data-toggle="tooltip" title="<?php echo $help_failure_order_status; ?>">
                                <?php echo $entry_order_status_failure; ?>
                            </span>
                                </label>
                                <div class="col-sm-10">
                                    <select name="ecomprocessing_checkout_order_failure_status_id" id="ecomprocessing_checkout_order_failure_status_id" class="form-control">
                                        <option value="" >- <?php echo $text_select_status; ?> -</option>
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ecomprocessing_checkout_geo_zone_id" id="input-geo-zone" class="form-control">
                                        ...
                                        <?php if ($geo_zone['geo_zone_id'] == $ecomprocessing_checkout_geo_zone_id) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_status"
                                           value="<?php echo $ecomprocessing_checkout_status;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_debug"
                                           value="<?php echo $ecomprocessing_checkout_debug;?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                        ...
                        <div class="tab-pane" id="tab-recurring">
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_supports_recurring; ?>">
                                ...
                                <div class="col-sm-10 bootstrap-checkbox-holder">
                                    <input type="hidden" name="ecomprocessing_checkout_supports_recurring"
                                           value="<?php echo $ecomprocessing_checkout_supports_recurring; ?>" />
                                    <input type="checkbox" class="bootstrap-checkbox"
                                    <?php if ($ecomprocessing_checkout_supports_recurring) { ?>
                                    checked="checked"
                                    <?php } ?>
                                    />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="<?php echo $module_name;?>_recurring_transaction_type" name="<?php echo $module_name;?>_recurring_transaction_type[]" class="form-control" multiple="multiple">
                                        ...
                                        <?php if (is_array($ecomprocessing_checkout_recurring_transaction_type) && in_array($recurring_transaction_type['id'], $ecomprocessing_checkout_recurring_transaction_type)) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="ecomprocessing_checkout_recurring_token" name="ecomprocessing_checkout_recurring_token" value="<?php echo $ecomprocessing_checkout_recurring_token; ?>" placeholder="<?php echo $entry_recurring_token; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="ecomprocessing_checkout_cron_time_limit" name="ecomprocessing_checkout_cron_time_limit" value="<?php echo $ecomprocessing_checkout_cron_time_limit; ?>" placeholder="<?php echo $entry_cron_time_limit; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="ecomprocessing_checkout_cron_allowed_ip" name="ecomprocessing_checkout_cron_allowed_ip" value="<?php echo $ecomprocessing_checkout_cron_allowed_ip; ?>" placeholder="<?php echo $entry_cron_allowed_ip; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        destroyBootstrapValidator('#form-ecomprocessing_checkout');
        createBootstrapValidator('#form-ecomprocessing_checkout');
        ...
        $('#form-ecomprocessing_checkout').submit(function() {
            var $form = $(this);
        ...
        $('input.bootstrap-checkbox').change(function() {
            ...
            if ($(this).parent().find('input[type="hidden"]').attr('name') == 'ecomprocessing_checkout_supports_recurring')
            {
                if (!isChecked)
                {
