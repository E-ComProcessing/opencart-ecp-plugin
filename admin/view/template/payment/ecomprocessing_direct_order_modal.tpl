...
<script type="text/javascript">
    ...
    $(function(){
        ...
        <?php if (($type == 'capture') || ($type == 'refund')) {
            if (($type == 'capture' && !$ecomprocessing_direct_supports_partial_capture) ||
            ($type == 'refund' && !$ecomprocessing_direct_supports_partial_refund)) { ?>
            $('#<?php echo $module_name;?>_transaction_amount').attr('readonly', 'readonly');
            <?php } ?>
            <?php }
        else if (($type == 'void') && (!$transaction['is_allowed'] || !$ecomprocessing_direct_supports_void)) { ?>
