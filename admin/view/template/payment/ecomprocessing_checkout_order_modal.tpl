    ...
    <div class="modal-content">
        <?php if ($type == 'capture') { ?>
            <div class="modal-header">
                ...
                <span class="ecomprocessing-logo"><h4 id="myModalLabel"><?php echo $text_modal_title_capture; ?></h4></span>
            </div>
        ...
        <?php }
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <span class="ecomprocessing-logo"><h4 id="myModalLabel"><?php echo $text_modal_title_refund; ?></h4></span>
            </div>
            <div class="modal-body">
                <div class="alert alert-notification alert-dismissible">
                    <i class="fa fa-info-circle"></i>
        ...
        <?php }
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <span class="ecomprocessing-logo"><h4 id="myModalLabel"><?php echo $text_modal_title_void; ?></h4></span>
            </div>
            <div class="modal-body">
                <div class="alert alert-notification alert-dismissible">
                    <i class="fa fa-info-circle"></i>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        <?php if (($type == 'capture') || ($type == 'refund')) {
            if (($type == 'capture' && !$ecomprocessing_checkout_supports_partial_capture) ||
                ($type == 'refund' && !$ecomprocessing_checkout_supports_partial_refund)) { ?>
                $('#<?php echo $module_name;?>_transaction_amount').attr('readonly', 'readonly');
            <?php } ?>
        <?php }
        else if (($type == 'void') && (!$transaction['is_allowed'] || !$ecomprocessing_checkout_supports_void)) { ?>
