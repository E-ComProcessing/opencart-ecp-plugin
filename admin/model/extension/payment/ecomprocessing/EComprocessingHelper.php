...
if (!class_exists('\Genesis\Genesis', false)) {
	if (strpos(DIR_APPLICATION, 'admin') === false) {
		...
		$path = DIR_APPLICATION . 'model/extension/payment/ecomprocessing/genesis/vendor/autoload.php';
	}
...
if (!class_exists('ModelExtensionPaymentEcomprocessingBase', false)) {
	if (strpos(DIR_APPLICATION, 'admin') === false) {
		...
		$path = DIR_CATALOG . 'model/extension/payment/ecomprocessing/base_model.php';
	}
