...
class ModelExtensionPaymentEComprocessingDirect extends Model
{
	...
	public function uninstall()
	{
		...
		//$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "ecomprocessing_direct_transactions`;");

		$this->load->model('setting/setting');

		$this->model_setting_setting->deleteSetting('ecomprocessing_direct');
	}
	...
	{
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "ecomprocessing_direct_transactions` WHERE `order_id` = '" . intval($order_id) . "'");
