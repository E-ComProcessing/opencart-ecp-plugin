<?php
// Heading
$_['heading_title']					= 'E-ComProcessing Direct';

// Text
$_['text_payment']					= 'Payment';
$_['text_success']					= 'Success: You have modified your E-ComProcessing configuration!';
$_['text_edit']                     = 'Edit E-ComProcessing';
$_['text_ecomprocessing_direct']		= '<a href="https://e-comprocessing.net/" target="_blank"><img src="view/image/payment/ecomprocessing.png" alt="E-ComProcessing Official Website" title="E-ComProcessing" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_yes']                      = 'Yes';
$_['text_no']                       = 'No';
